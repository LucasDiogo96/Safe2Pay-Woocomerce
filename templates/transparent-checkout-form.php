	...
	<?php if ('yes' == $tc_ticket) : ?>
		...
		<?php if ('yes' == $tc_cryptocurrency) : ?>
			<li><label>
					...
					<?php _e('Criptomoeda', 'woo-safe2pay'); ?>
	...
	<?php if ('yes' == $tc_credit) : ?>
		<div id="safe2pay-credit-card-form" class="safe2pay-method-form">
			...
			<p id="safe2pay-card-holder-name-field" class="form-row form-row-first">
				<label for="safe2pay-card-holder-name"><?php _e('Nome impresso no cartão', 'woo-safe2pay'); ?><span class="required">*</span></label>
			...
			<p id="safe2pay-card-number-field" class="form-row form-row-last">
				<label for="safe2pay-card-number"><?php _e('Número do cartão', 'woo-safe2pay'); ?> <span class="required">*</span></label>
			...
			<p id="safe2pay-card-expiry-field" class="form-row form-row-first">
				<label for="safe2pay-card-expiry"><?php _e('Validade (MM/YYYY)', 'woo-safe2pay'); ?> <span class="required">*</span></label>
				<input maxlength="7" onkeypress="return ExpiryMask(event,this)" id="safe2pay-card-expiry" name="input-text wc-credit-card-form-card-expiry" type="tel" autocomplete="off" placeholder="<?php _e('MM / YYYY', 'woo-safe2pay'); ?>" style="font-size: 1.5em; padding: 8px; width: 100%;" />
			</p>
			<p id="safe2pay-card-cvc-field" class="form-row form-row-last">
				<label for="safe2pay-card-cvc"><?php _e('CVV', 'woo-safe2pay'); ?> <span class="required">*</span></label>
				<input maxlength="4" onkeypress="return IsNumber(event)" id="safe2pay-card-cvc" name="input-text wc-credit-card-form-card-cvc" type="tel" autocomplete="off" placeholder="<?php _e('CVV', 'woo-safe2pay'); ?>" style="font-size: 1.5em; padding: 8px;width: 100%;" />
			</p>
			<div class="clear"></div>
			<p id="safe2pay-card-installments-field" class="form-row form-row-first">
				<label for="safe2pay-card-installments"><?php _e('Parcelar em', 'woo-safe2pay'); ?></label>
	...
	<?php if ('yes' == $tc_debit) : ?>
		...
		<div id="safe2pay-debit-card-form" class="safe2pay-method-form">
			...
			<p id="safe2pay-debit-card-holder-name-field" class="form-row form-row-first">
				<label for="safe2pay-debit-card-holder-name"><?php _e('Nome impresso no cartão', 'woo-safe2pay'); ?><span class="required">*</span></label>
			...
			<p id="safe2pay-debit-card-number-field" class="form-row form-row-last">
				<label for="safe2pay-debit-card-number"><?php _e('Número do cartão', 'woo-safe2pay'); ?> <span class="required">*</span></label>
			...
			<p id="safe2pay-debit-card-expiry-field" class="form-row form-row-first">
				<label for="safe2pay-debit-card-expiry"><?php _e('Validade (MM/YYYY)', 'woo-safe2pay'); ?> <span class="required">*</span></label>
				<input maxlength="7" onkeypress="return ExpiryMask(event,this)" id="safe2pay-debit-card-expiry" name="safe2pay-debit-card-expiry" type="tel" autocomplete="off" placeholder="<?php _e('MM / YYYY', 'woo-safe2pay'); ?>" style="font-size: 1.5em; padding: 8px; width: 100%;" />
			</p>
			<p id="safe2pay-debit-card-cvc-field" class="form-row form-row-last">
				...
				<input maxlength="4" onkeypress="return IsNumber(event)" id="safe2pay-debit-card-cvc" name="safe2pay-debit-card-cvc" type="tel" autocomplete="off" placeholder="<?php _e('CVV', 'woo-safe2pay'); ?>" style="font-size: 1.5em; padding: 8px;width: 100%;" />
			</p>
			<div class="clear"></div>
		</div>
	<?php endif; ?>
